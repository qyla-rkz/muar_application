  ...
  Future<void> signUp() async {
    ...
    try {
      ...
      await NotificationService.sendNotification(
        receiverId: 'admin',
        title: 'Permohonan Merchant Baru',
        body: '${nameController.text.trim()} telah memohon sebagai merchant.',
        type: 'alert',
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                "✅ Permohonan merchant dihantar! Emel pengesahan telah dihantar.")),
      );
      ...
      if (mounted) Navigator.pushReplacementNamed(context, '/merchant_login');
    } catch (e) {
          ...
          flexibleSpace: Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromARGB(255, 49, 113, 113),
                  Color.fromARGB(255, 20, 150, 217),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              const Text(
                "Akaun merchant memerlukan kelulusan selepas pendaftaran.",
              ...
              const SizedBox(height: 20),
              buildTextField("Nama Penuh / Pemilik Perniagaan", nameController,
                  validator: (val) =>
                      val == null || val.isEmpty ? "Masukkan nama anda" : null),
              buildTextField("No. Telefon Perniagaan", phoneController,
                  icon: Icons.phone,
                  validator: (val) => val == null || val.length < 10
                      ? "Masukkan no. telefon yang sah"
                      : null),
              buildTextField("Emel Perniagaan", emailController,
                  icon: Icons.email,
                  validator: (val) => val == null || !val.contains("@")
                      ? "Masukkan emel yang sah"
                      : null),
              buildTextField("Nama Samaran Kedai", nicknameController,
                  validator: (val) => val == null || val.isEmpty
                      ? "Masukkan nama samaran kedai"
                      : null),
